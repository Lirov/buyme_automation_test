...
driver.find_element_by_id("ember959").send_keys("Bb12345678@gmail.com")
...
# driver.find_element_by_id("ember901").send_keys("Liro")
# driver.find_element_by_id("ember902").send_keys("Bb12345678@gmail.com")
...
print(a)
time.sleep(3)
driver.find_element_by_id("ember1154").send_keys("350")
...
driver.find_element_by_xpath("//*[@id='ember1241']").send_keys("אמא")
driver.find_element_by_id("ember1243").send_keys("לירון")
...
driver.find_element_by_xpath("//*[@id='ember1265']/textarea").send_keys("מזל טוב ליום הולדתך ולעוד הרבה שנים נפלאות")
...
driver.find_element_by_xpath("//*[@id='ember1707']").send_keys("mom@gmail.com")
